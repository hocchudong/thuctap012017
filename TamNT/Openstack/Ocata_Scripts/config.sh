...
CTL_EXT_IP=192.168.101.61
CTL_DATA_IP=10.10.20.61
CTL_MGNT_IF=ens3
CTL_EXT_IF=ens4
CTL_DATA_IF=ens5

# Assigning IP for Compute1 host
COM1_MGNT_IP=10.10.10.62
COM1_EXT_IP=192.168.101.62
COM1_DATA_IP=10.10.20.62
COM1_MGNT_IF=ens3
COM1_EXT_IF=ens4
COM1_DATA_IF=ens5

# Assigning IP for Compute1 host
CINDER_MGNT_IP=10.10.10.63
CINDER_EXT_IP=192.168.101.63
CINDER_DATA_IP=10.10.20.63
CINDER_MGNT_IF=ens3
CINDER_EXT_IF=ens4
CINDER_DATA_IF=ens5

# Gateway for EXT network
GATEWAY_IP_EXT=192.168.101.1
...
START_IP_ADDRESS=192.168.101.150
END_IP_ADDRESS=192.168.101.160
DNS_RESOLVER=8.8.8.8
PROVIDER_NETWORK_CIDR=192.168.101.0/24
## Password variable
# Set password
